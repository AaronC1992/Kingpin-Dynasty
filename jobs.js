...
export const jobs = [
    // Entry Level Job
    { name: "Street Soldier", payout: [300, 1500], risk: "low", jailChance: 20, wantedLevelGain: 1, healthLoss: 0, requiredItems: [], reputation: 0, energyCost: 1 },
    ...
    // Higher Risk Job
    { name: "Store Heist", payout: [6000, 15000], risk: "high", jailChance: 30, wantedLevelGain: 4, healthLoss: 10, requiredItems: [], reputation: 10, energyCost: 10 },
    
    // NEW LATE-GAME JOBS
    
    // Drug dealing jobs
    { name: "Bootleg Run", payout: [12000, 30000], risk: "high", jailChance: 25, wantedLevelGain: 3, healthLoss: 5, requiredItems: ["Crate Moonshine"], reputation: 15, energyCost: 12 },
    { name: "Speakeasy Supply", payout: [25000, 55000], risk: "very high", jailChance: 35, wantedLevelGain: 5, healthLoss: 8, requiredItems: ["Bag of Mary Jane"], reputation: 25, energyCost: 15 },
    { name: "White Powder Distribution", payout: [50000, 110000], risk: "extreme", jailChance: 45, wantedLevelGain: 8, healthLoss: 15, requiredItems: ["Pure Cocaine"], reputation: 40, energyCost: 20 },
    
    // Weapon-based jobs
    { name: "Protection Collection", payout: [3000, 8000], risk: "medium", jailChance: 20, wantedLevelGain: 3, healthLoss: 8, requiredItems: ["Brass Knuckles"], reputation: 12, energyCost: 8 },
    { name: "Bank Job", payout: [35000, 85000], risk: "extreme", jailChance: 50, wantedLevelGain: 10, healthLoss: 20, requiredItems: ["Tommy Gun", "Bullets"], reputation: 35, energyCost: 25, paysDirty: true },
    { name: "Hit on a Rival", payout: [20000, 45000], risk: "very high", jailChance: 40, wantedLevelGain: 6, healthLoss: 25, requiredItems: ["Pistol", "Bullets"], reputation: 30, energyCost: 18 },
    
    // High-tech/Vehicle jobs
    { name: "Luxury Car Ring", payout: [25000, 55000], risk: "high", jailChance: 30, wantedLevelGain: 4, healthLoss: 5, requiredItems: ["Luxury Automobile"], reputation: 20, energyCost: 15 },
    { name: "Cross-Border Smuggling", payout: [65000, 140000], risk: "extreme", jailChance: 35, wantedLevelGain: 7, healthLoss: 10, requiredItems: ["Private Airplane", "Gasoline"], reputation: 50, energyCost: 30 },
    
    // Gang-based jobs
    { name: "Turf War", payout: [12000, 35000], risk: "very high", jailChance: 45, wantedLevelGain: 5, healthLoss: 30, requiredItems: ["Gang Recruit"], reputation: 25, energyCost: 20 },
    { name: "Underground Boxing", payout: [10000, 25000], risk: "high", jailChance: 25, wantedLevelGain: 2, healthLoss: 40, requiredItems: ["Brass Knuckles"], reputation: 18, energyCost: 12 },
    
    // Property-based jobs
    { name: "Illegal Gambling Den", payout: [40000, 85000], risk: "very high", jailChance: 30, wantedLevelGain: 4, healthLoss: 5, requiredItems: ["Criminal Safehouse"], reputation: 35, energyCost: 22 },
    { name: "Money Laundering", payout: [50000, 120000], risk: "high", jailChance: 20, wantedLevelGain: 3, healthLoss: 0, requiredItems: ["Basement Hideout", "Luxury Automobile"], reputation: 45, energyCost: 25, special: "launder_money" },
    
    // Counterfeiting job (pays dirty money only)
    { name: "Counterfeiting Money", payout: [65000, 175000], risk: "extreme", jailChance: 45, wantedLevelGain: 8, healthLoss: 0, requiredItems: ["Basement Hideout", "Fake ID Kit"], reputation: 40, energyCost: 20, paysDirty: true },
    
    // Elite endgame jobs
    { name: "International Arms Trade", payout: [175000, 350000], risk: "legendary", jailChance: 60, wantedLevelGain: 12, healthLoss: 10, requiredItems: ["Private Airplane", "Tommy Gun", "Bulletproof Vest"], reputation: 60, energyCost: 35 },
    { name: "Take Over the City", payout: [700000, 1750000], risk: "legendary", jailChance: 70, wantedLevelGain: 15, healthLoss: 20, requiredItems: ["Gang Recruit", "Underground Bunker", "Tommy Gun", "Luxury Automobile"], reputation: 80, energyCost: 40 }
];
